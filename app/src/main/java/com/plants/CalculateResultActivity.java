...
public class CalculateResultActivity extends AppCompatActivity {
    private TextView txtHeader, txtCurrentCarbonFootprint, txtCommutePercentage,
            txtElectricityPercentage, txtFoodPercentage, txtWastePercentage,
            txtRecommendation, txtDate;
    ...
    private void generateRecommendation(double commuteCarbon, double electricityCarbon,
                                        double foodCarbon, double wasteCarbon) {
